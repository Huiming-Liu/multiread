...
Component({
   ...
   */
  data: {
    playSrc: '../../components/wxs-diyAudioPlayer/audio-play.png', // 播放状态时的图片
    pauseSrc: '../../components/wxs-diyAudioPlayer/audio-stop.png', // 暂停状态时的图片
    isPlay: true, // 播放中false，停止true
